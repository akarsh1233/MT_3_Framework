...
public class ExcelUtility 
{
	...
	public String readDatafromExcel(String sheetname,int rownum,int cellnum) throws EncryptedDocumentException, IOException, Throwable 
	{
	...
	public int readNumericDatafromExcel(String sheetname,int rownum,int cellnum) throws EncryptedDocumentException, IOException, Throwable  
	{
		FileInputStream fis = new FileInputStream("../SDET6/SDET6.xlsx");
	...
	public int getLastRow(String sheetname) throws EncryptedDocumentException, IOException, Throwable 
	{
		FileInputStream fis = new FileInputStream("../SDET6/SDET6.xlsx");
