 package com.vTigerGenericlib;
	...
	public class WebDriverUtil 
	{
		 ...
		 * @author akarsh
		 * 
		 * this construtor is  to intialize webdriver variable 
		 * argument should be Web
		 * @param driver
		 */
		...
		/***
		 * @author akarsh
		 * this method will gives you the implicityWait max duration of 10 seconds
		 */
		...
		/***
		 * @author akarsh
		 * this methods make you wheath element method displayed or not 
		 * Argument should return is Webelement
		 * @param element
		 * @return booleen
		 */
		...
		public void implicitlywaitForElement(int i) {
